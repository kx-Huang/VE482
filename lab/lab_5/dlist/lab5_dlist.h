...
// REQUIRES: argument 'this' is non-null and is a valid list // EFFECTS: return
// whether the list 'this' is empty

void dlistAppend(dlist this, const char *key, dlistValue value);
// REQUIRES: type instantiated in 'value' corresponds to the datatype in the
// list
...
void dlistSort(dlist_const this, dlist listDst,
               dlistSortMethod method); // REQUIRES: argument 'this' is not null
                                        // and is a valid list
...
// EFFECTS: Print the content of 'this' in the required format to standard
// output. A newline must be followed after each line (including the last one).
